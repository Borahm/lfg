...
const Project = () => {
  ...
  return (
    ...
    <Flex flexDirection='column' width="60%" minWidth='60%' backgroundColor="white" borderRadius='8' mt='20' mb='20' boxShadow='xl'>
      <>
        <Flex name='hero' borderColor='gray.100'>
          <Flex name='project-box' borderRadius='8' backgroundColor='gray.100' width='100%'>
            <Flex display='flex' >
              <Image src={project.project_image} maxWidth='300px' objectFit='cover' alt='project image' borderTopLeftRadius='8' />
            </Flex>
            <Box name='box-content' p='10' display='flex' flexDirection='column' justifyContent='center' >
